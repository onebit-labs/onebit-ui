...
const Privacy: FC = () => {
  return (
    <Card>
      ...
      <CardContent>
        <Stack spacing={2}>
          <H2>Onebit Finance Privacy Policy</H2>
          <Paragraph>Last updated: November 05, 2022</Paragraph>
          <Paragraph>
            participants who are visitors of https://defi.onebit.com (the “Interface”). Onebit does it best to collect as minimum Personal Data as possible. Still, it’s quite a task not to collect it at all. That is why this Privacy Policy document contains types of data that is collected, used, and recorded by Interface. 
          </Paragraph>
          <Paragraph>
            Onebit Finance is the controller for your Personal Data within the scope of this Privacy Policy. The Onebit decides “why” and “how” your Personal Data is processed in connection with the Interface. If you have additional questions or require more information about this Privacy Policy, do not hesitate to contact info@onebit.com. 
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            Below is the categories of our processors used on the Interface due to an internal data processing roadmap providing a brief grasp of our data processing activities with regard to each piece of the Personal Data we may collect through the Interface, as well as your place in every data processing event. Below are the categories of our processors which can access and process your Personal Data through the Interface: 
          </Paragraph>
          <Stack spacing={1}>
            <Paragraph>
            ...
            <Paragraph>
              3) Merch products delivery vendors; 
            </Paragraph>
            <Paragraph>
          ...
          <H5>4. Data processing in connection with the Interface </H5>
          <H5>Types of Data Collected</H5>
          <Paragraph>
            To the maximum extent possible, Interface tries to collect as minimum Personal Data from you as possible. Personal Data we collect: 
          </Paragraph>
          <Stack spacing={1}>
            <Paragraph>
            ...
            <Paragraph>
              - IP address, MAC address, log files, domain server, data related to usage, performance, website security, traffic patterns, location information, browser and device information – only when you are using the dApp; 
            </Paragraph>
            <Paragraph>
            ...
            <Paragraph>
              - Your name and address you provide to us when ordering our merch products. 
            </Paragraph>
          </Stack>
          <Paragraph>
            Onebit may also engage third-parties advertising platforms that are triggered only when their technical features (so-called “pixels”) are enabled through the Interface. The mentioned thirdparties advertising platforms may collect Personal Data of Interface`s visitors only with the purpose to optimize their advertising possibilities through their platforms, target you with their advertisements, and possibly share your data with other advertising platforms and agencies for further use. 
          </Paragraph>
          <Paragraph>
            In no event we are going to ask you to share your private keys or wallet seed. Never trust anyone or any website that asks you to enter your private keys or wallet seed. 
          </Paragraph>
          <H5>How and Why we use your Personal Data</H5>
          <Paragraph>We may use your Personal Data listed above only for: </Paragraph>
          <Stack spacing={1}>
            <Paragraph>
          ...
          <Stack spacing={1}>
            ...
            <Paragraph>
              - On the basis of our or our processors’ legitimate interests to protect the Interface, prevent any malicious and harmful activities to the Interface, maintain our technical systems healthy and secure, improve services and products by using aggregate statistics; 
            </Paragraph>
            <Paragraph>
              - To respond to legal requests of authorities, provide information upon court orders and judgments, or if we have a good-faith belief that such disclosure is necessary and abide the law in order to comply with official investigations or legal proceedings initiated by governmental and/or law enforcement officials, or private parties, including but not limited to: in response to subpoenas, search warrants, or court orders, and including other similar statutory obligations we or our processors are subjected to; 
            </Paragraph>
            <Paragraph>
          ...
          <Stack spacing={1}>
            ...
            <Paragraph>
              - To our subsidiaries or affiliates (if any) only if necessary for operational purposes. 
            </Paragraph>
          </Stack>
          <Paragraph>
          ...
          <Paragraph>
            You may contact us by email at the following email address: info@onebit.com ; We use the data that you provide in an email to us, which you may give voluntarily, only in order to answer your question or to reply to your email in the best possible manner. 
          </Paragraph>
          <H5>5. Cookies and Automatically Collected Data</H5>
          <Paragraph>
          ...
          <Paragraph>
            Please email to: info@onebit.com with any questions about exercising any of the above rights. If You wish to learn more about the GDPR and Your rights, the Information Commissioner’s Office website is a reliable source.
          </Paragraph>
          <H5>7. Privacy of children </H5>
          <Paragraph>
