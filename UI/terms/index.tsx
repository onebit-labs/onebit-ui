    ...
    <Card>
      ...
      <CardContent>
        <Stack spacing={2}>
          ...
          <H5>2. Compliance Obligations</H5>
          <Paragraph>
          ...
          <H5>3. Access to the Interface</H5>
          <Paragraph>
          ...
          <Paragraph>
            You acknowledge that Onebit is not responsible for transferring, safeguarding, or maintaining your private keys. If you lose, mishandle or have stolen associated virtual currency private keys, you acknowledge that you may not be able to recover associated virtual currency and that Onebit is not responsible for such loss. You acknowledge that Onebit is not responsible for any loss, damage or liability arising from your failure to comply with the terms hereunder. 
          </Paragraph>
          <Paragraph>
          ...
          <H5>6. Intellectual Proprietary Rights</H5>
          <Paragraph>
          ...
          <H5>9. Arbitration and Class Action Waiver</H5>
          <Paragraph>
            Binding Arbitration. Except for disputes in which either party seeks to bring an individual action in small claims court or seeks injunctive or other equitable relief for the alleged unlawful use of copyrights, trademarks, trade names, logos, trade secrets or patents, you and the Onebit: (a) waive the right to have any and all disputes or claims arising from these Terms, your use or access to the Interface or any other disputes with the Onebit (collectively, “Disputes”) resolved in a court; and (b) waive any right to a jury trial. Instead, you and the Onebit agree to arbitrate Disputes that are not resolved informally (as described below) through binding arbitration (i.e. the referral of a Dispute to one or more persons charged with reviewing the Dispute and making a final and binding determination to resolve it) instead of having the Dispute decided by a judge or jury in court). 
          </Paragraph>
          <Paragraph>
            No Class Arbitrations, Class Actions or Representative Actions. You and the Onebit agree that any dispute is personal to you and the Onebit and that any such dispute will be resolved solely through individual arbitration and will not be brought as a class arbitration, class action or any other type of representative proceeding. Neither party agrees to class arbitration or to an arbitration in which an individual attempt to resolve a dispute as a representative of another individual or group of individuals. Further, you and the Onebit agree that a dispute cannot be brought as a class, or other types of representative action, whether within or outside of arbitration, or on behalf of any other individual or group of individuals. 
          </Paragraph>
          <Paragraph>
            Process. You and the Onebit agree that each will notify the other, in writing, of any Dispute within thirty (30) days of when it arises so that the parties can attempt, in good faith, to resolve the Dispute informally. Notice to the Onebit shall be provided by sending an email to info@onebit.com. Your notice must include (1) your name, postal address, and email address; (2) a description of the nature or basis of the Dispute; and (3) the specific action that you are seeking. If you and the Onebit cannot resolve the Dispute within thirty (30) days of the Onebit receiving the notice, either you or Onebit may, as appropriate pursuant to this Section 9, commence an arbitration proceeding. You and the Onebit agree that any arbitration or claim must be commenced or filed within one (1) year after the Dispute arose; otherwise, you and the Onebit agree that the claim is permanently barred (which means that you will no longer have the right to assert a claim regarding the Dispute). 
          </Paragraph>
          <Paragraph>
            Choice of Law. These Terms are governed by and will be construed under the laws of the Cayman Islands, without regard to principles of conflict of laws, govern the Terms and any Dispute between you and us. Any judgment on the award rendered by the arbitrator may be entered in any court of competent jurisdiction, to the extent a court therein would be deemed to be a court of competent jurisdiction other than any court located in the United States of America. You further agree that the Interface shall be deemed to be based solely in the Cayman Islands and that, although the Interface may be available in other jurisdictions, its availability does not give rise to general or specific personal jurisdiction in any forum outside the Cayman Islands. 
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            Entire Agreement. These Terms (and any additional terms, rules and conditions of participation that may be posted on the website of Onebit Finance) including the Privacy Policy constitute the entire agreement with respect to the Interface and supersedes any prior agreements, oral or written. 
          </Paragraph>
          <Paragraph>
