...
const ChevronRightStyled = styled(ChevronRightIcon)<CollapseCompact>(({ collapsed, compact }) => ({
  fontSize: 18,
...
const SidebarAccordion: FC<React.PropsWithChildren<SidebarAccordionProps>> = (props) => {
