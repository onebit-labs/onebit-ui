const locale = {
  wallet: {
    ...
    signature: {
      ...
      thingsToKnowContent:
        'You are not guaranteed to make money by investing any products offered on Onebit Defi (in Beta). Past performance is not an indication of future results. You alone are responsible for the safety of your funds. Your capital is at risk.',
      accept: 'Accept',
      decline: 'Decline',
    ...
    KYT: {
      tip: 'This product requires user wallet addresses to pass KYT checks and be whitelisted before depositing funds.',
