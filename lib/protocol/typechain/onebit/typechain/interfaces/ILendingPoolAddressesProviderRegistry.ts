...
export interface ILendingPoolAddressesProviderRegistryInterface extends utils.Interface {
  functions: {
...
export type AddressesProviderRegisteredEvent = TypedEvent<[string], AddressesProviderRegisteredEventObject>
...
export type AddressesProviderUnregisteredEvent = TypedEvent<[string], AddressesProviderUnregisteredEventObject>
...
export interface ILendingPoolAddressesProviderRegistry extends BaseContract {
  ...
  filters: {
    ...
    AddressesProviderRegistered(newAddress?: PromiseOrValue<string> | null): AddressesProviderRegisteredEventFilter
