...
export interface ReserveLogicInterface extends utils.Interface {
  ...
  events: {
    'ReserveDataUpdated(address,uint256,uint256)': EventFragment
  }
...
export type ReserveDataUpdatedEvent = TypedEvent<[string, BigNumber, BigNumber], ReserveDataUpdatedEventObject>
...
export interface ReserveLogic extends BaseContract {
  ...
  filters: {
    'ReserveDataUpdated(address,uint256,uint256)'(
